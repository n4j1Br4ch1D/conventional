function Hero() {
  const scrollToAppView = () => { //view :String
...
<div className="bg-hero bg-gray-100 dark:bg-transparent">
                <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
                    <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
                        ...
                        Provide consistent developer experience across many application &amp; teams, 
                        using our convention templates generator tool.
                        <a className="text-purple-700" href="http://" target="_blank" rel="noopener noreferrer"> Read More...</a>
                        </p>
                    </div>
                    <div className="flex justify-center items-center">
<button onClick={scrollToAppView} className="mr-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hidden md:block bg-transparent transition duration-150 ease-in-out hover:bg-gray-200 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-transparent transition duration-150 ease-in-out hover:border-indigo-600 lg:text-xl lg:font-bold  hover:text-indigo-600 rounded border border-indigo-700 text-indigo-700 px-4 sm:px-10 py-2 sm:py-4 text-sm">
...
<button onClick={scrollToAppView} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-700 bg-purple-700 transition duration-150 ease-in-out hover:bg-indigo-600 lg:text-xl lg:font-bold  rounded text-white px-4 sm:px-10 border border-indigo-700 py-2 sm:py-4 text-sm">
