function Topbar() {
  ...
  function toggleFullscreen(toggle: boolean) {
    const elem = document.getElementById('apllication-wrapper');
    if (!toggle) {
    ...
    <div className="topBar">
      <div className="flex justify-between">
        <div>
          <button
            type="button"
            className="hidden text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800 inline-flex items-center"
          >
            <svg
              aria-hidden="true"
              role="status"
        ...
        <div>
          <div className="inline-flex">
            ...
            <button
              ...
              type="button"
              className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
