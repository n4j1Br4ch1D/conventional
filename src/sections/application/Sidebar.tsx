    ...
    <div className="sidebar w-1/4 overflow-y-auto text-right bg-gray-900 p-2">
      ...
      <div className="flex text-left mt-2 rounded-md shadow-sm">
        <a
          href="#"
          aria-current="page"
          className="w-full py-2 px-4 text-sm font-medium text-gray-100 bg-gray-700 rounded-l-lg border border-gray-600 hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-purple-700 focus:text-purple-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-purple-500 dark:focus:text-white"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
