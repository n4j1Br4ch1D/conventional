...
<footer className="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900">
    <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
            ...
            <li>
                <a className="hover:underline" href="https://anmoonweb.com/?ref=anmoon-convention-genrator#contact" target="_blank" rel="noopener noreferrer">Contact</a>
            </li>
        </ul>
    </div>
    <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 
       <Link  href="/licensing" className="hover:underline"> Conventional</Link>. All Rights Reserved.
    </span>
</footer>
